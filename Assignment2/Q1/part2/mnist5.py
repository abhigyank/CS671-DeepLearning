...
conv2 = Conv2D(64, kernel_size=(2,2), strides=2, activation='relu')(normalize1)
...
model.compile(loss='categorical_crossentropy', optimizer=Adam(lr=0.01, beta_1=0.95), metrics=['accuracy'])

print(model.summary())


model_json = model.to_json()
with open("models/mnist5.json", "w") as json_file:
...
print (cm)
# [[ 973    0    1    0    1    0    3    2    0    0]
#  [   0 1128    3    0    0    1    3    0    0    0]
#  [   5    0 1007    3    1    0    0   11    5    0]
#  [   1    0    2  994    0   10    0    1    0    2]
#  [   1    1    0    0  974    0    2    0    0    4]
#  [   0    0    0    5    0  880    2    1    1    3]
#  [   7    4    0    0    2    4  940    0    0    1]
#  [   0    4    3    1    0    1    0 1016    1    2]
#  [   0    1    2    1    1    2    0    3  956    8]
#  [   0    3    0    0   10    3    0    8    3  982]]